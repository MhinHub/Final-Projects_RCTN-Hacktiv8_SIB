...
export default ({ news }) => {
    return (
        <article className="flex flex-col py-8 px-4 rounded-md border border-black bg-transparent w-fit h-auto">
            <a href={news.url} target="_blank" rel="noreferrer">
                ...
                <div className="flex-col px-2 w-[fit-content]">
                    <h3 className="text-2xl leading-6"><strong>{news?.title}</strong></h3>
